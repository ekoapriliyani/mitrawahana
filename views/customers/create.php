...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0"><i class="fas fa-user-plus me-2"></i>Add New Customer</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="customer_type" name="customer_type">
                            <option value="individual" <?php echo (isset($_POST['customer_type']) && $_POST['customer_type'] == 'individual') ? 'selected' : ''; ?>>Individual</option>
                            <option value="company" <?php echo (isset($_POST['customer_type']) && $_POST['customer_type'] == 'company') ? 'selected' : ''; ?>>Company</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="pic_phone" name="pic_phone" 
                               value="<?php echo $_POST['pic_phone'] ?? ''; ?>">
                    </div>
                </div>
